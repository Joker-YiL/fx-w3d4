...
class RateControllerTest {
    ...
    @Test
    void listsLatestRates() throws Exception {
    ...
    @Test
    void unknownPairIs404WithErrorBody() throws Exception {
    ...
    @Test
    void negativeAmountIs400EvenThoughServiceIsMocked() throws Exception {
        mvc.perform(post("/api/conversions")
                        .contentType(MediaType.APPLICATION_JSON)
